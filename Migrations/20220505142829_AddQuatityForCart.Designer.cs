...
namespace FPT_Book.Migrations
{
    ...
    [Migration("20220505142829_AddQuatityForCart")]
    partial class AddQuatityForCart
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FPT_Book.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("FPT_Book.Models.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FPT_Book.Models.Book", b =>
                {
                    b.HasOne("FPT_Book.Models.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("FPT_Book.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("FPT_Book.Models.Order", "Order")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FPT_Book.Areas.Identity.Data.AppUser", null)
                        .WithMany()
